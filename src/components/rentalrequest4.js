...
class Rentalrequest4 extends Component {
  render() {
    return (
      <div>
        ...
        <div className="container-fluid">
          <div className="row" style={{marginTop: '60px', marginLeft: '180px', marginRight: '10px'}}>
            ...
            <div className="row" style={{marginTop: '160px', marginLeft: '180px', marginRight: '10px'}}>
              <h5 className="head" style={{borderBottom: '0.5px dashed #333333', paddingBottom: '5px'}}> Category Name &nbsp; Subcategory<strong> &nbsp; Equipments</strong></h5>
            </div>
          </div></div></div>
    );
  }
