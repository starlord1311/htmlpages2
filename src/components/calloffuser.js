...
import './calloffuser.css';

class Calloffuser extends Component {
  render() {
    return (
      <div>
             ...
             <div className="sidenav">
               <ul>
                 <li><span style={{marginRight: '3px'}} className="glyphicon glyphicon-th-list" />List Allocation
                   <ul>
                     <li>Vendors List</li>
                   </ul>
                 </li>
                 <li><span style={{marginRight: '3px'}} className="glyphicon glyphicon-info-sign" />Daily Order
                   <ul>
                     <li>Supplied</li>
                     <li>Supplied</li>
                   </ul>
