...
import './auctionuser.css';

class Auctionuser extends Component {
  render() {
    return (
      <div>
              ...
              <div className="sidenav">
                <ul>
                  <li><span style={{marginRight: '3px'}} className="glyphicon glyphicon-th-list" />User Request</li>
                  <li><span style={{marginRight: '3px'}} className="glyphicon glyphicon-info-sign" />Equipment List
                    <ul>
                      <li>For Auction</li>
                      <li>For Sale</li>
                    </ul>
