    ...
    return (
      <div>
        ...
        <div className="container-fluid">
          <div className="row" style={{marginTop: '60px', marginLeft: '180px', marginRight: '10px', border: '1px solid grey', width: '82%', paddingTop: '15px', paddingLeft: '15px', paddingBottom: '25px', borderRadius: '6px', backgroundColor: '#eef1f6'}}>
            <h4 className="head" style={{borderBottom: '0.5px solid #333333', paddingBottom: '5px'}}><strong>Create</strong></h4>
            <div style={{marginTop: '10px', textAlign: 'left'}} className="col-md-2">
            ...
            <div style={{marginTop: '10px', textAlign: 'left'}} className="col-md-6">
              <form action="/action_page.php">
                <input type="text" name style={{border: '1px solid grey', borderRadius: '3px', width: '325px'}} /><br /><br />
                <div className="form-group">
                  <select style={{width: '325px', height: '24px', padding: '1px'}} className="form-control" id="sel1">
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
                    <option>4</option>
                ...
                <input type="text" name style={{border: '1px solid grey', borderRadius: '3px', width: '325px'}} /><br /><br />
                <input type="date" name style={{border: '1px solid grey', borderRadius: '3px', marginRight: '6px'}} />to<input type="date" name style={{border: '1px solid grey', borderRadius: '3px', marginLeft: '6px'}} /><br /><br />
                <input type="text" name style={{border: '1px solid grey', borderRadius: '3px', width: '325px'}} />
                <input type="text" name style={{border: '1px solid grey', borderRadius: '3px', width: '325px', marginTop: '10px'}} /><br /><br />
                <button style={{backgroundColor: '#0c7cb3', border: 'none', padding: '5px 10px', borderRadius: '3px', color: 'white'}} className="btn1">Submit</button>
                <a href="project view.html" className="btn1" style={{backgroundColor: '#0c7cb3', color: 'white', padding: '7px 10px', borderRadius: '3px', marginLeft: '10px'}}>Cancel</a>
              </form>
            </div>
          </div>
